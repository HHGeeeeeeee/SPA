...
export const KIOSK_DICTS: Record<KioskLocale, KioskDict> = {
  'zh-TW': {
    ...
    genderNa: '不願透露',
    service: '想做的服務',
    servicePlaceholder: '例如：全身按摩、肩頸放鬆',
    pressure: '按摩力道',
    pressureSoft: '輕',
    pressureMedium: '中',
    pressureHard: '重',
    ...
    yes: '是',
    no: '否',
    healthNote: '如以上有任何一項為「是」，請說明',
    healthNotePlaceholder: '請說明（選填）',
    consentTitle: '同意聲明',
    consentText:
  ...
  en: {
    ...
    service: 'Service you would like',
    servicePlaceholder: 'e.g. full-body massage, neck & shoulders',
    ...
    yes: 'Yes',
    no: 'No',
    healthNote: 'If you answered “Yes” to any of the above, please explain',
    healthNotePlaceholder: 'Please explain (optional)',
  ...
  ja: {
    ...
    genderNa: '回答しない',
    service: 'ご希望の施術',
    servicePlaceholder: '例：全身マッサージ、首・肩',
    pressure: 'マッサージの強さ',
    pressureSoft: '弱め',
    pressureMedium: '普通',
    pressureHard: '強め',
    ...
    yes: 'はい',
    no: 'いいえ',
    healthNote: '上記で「はい」がある場合はご記入ください',
    healthNotePlaceholder: 'ご記入ください（任意）',
    consentTitle: '同意事項',
    consentText:
  ...
  ko: {
    ...
    genderNa: '응답하지 않음',
    service: '원하시는 서비스',
    servicePlaceholder: '예: 전신 마사지, 목·어깨',
    pressure: '마사지 강도',
    pressureSoft: '약하게',
    pressureMedium: '보통',
    pressureHard: '강하게',
    ...
    yes: '예',
    no: '아니오',
    healthNote: '위 항목 중 “예”가 있으면 설명해 주세요',
    healthNotePlaceholder: '설명 (선택)',
    consentTitle: '동의 사항',
    consentText:
  ...
  de: {
    ...
    servicePlaceholder: 'z. B. Ganzkörpermassage, Nacken & Schultern',
    ...
    yes: 'Ja',
    no: 'Nein',
    healthNote: 'Wenn Sie eine der obigen Fragen mit „Ja“ beantwortet haben, bitte erläutern',
    healthNotePlaceholder: 'Bitte erläutern (optional)',
  ...
  es: {
    ...
    service: 'Servicio que desea',
    servicePlaceholder: 'p. ej. masaje de cuerpo completo, cuello y hombros',
    ...
    yes: 'Sí',
    no: 'No',
    healthNote: 'Si respondió “Sí” a alguna de las anteriores, por favor explique',
    healthNotePlaceholder: 'Por favor explique (opcional)',
  ...
  it: {
    ...
    servicePlaceholder: 'es. massaggio corpo completo, collo e spalle',
    ...
    yes: 'Sì',
    no: 'No',
    healthNote: 'Se hai risposto “Sì” a una delle precedenti, spiega',
    healthNotePlaceholder: 'Spiega (facoltativo)',
