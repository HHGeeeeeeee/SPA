    ...
    <Document title={`SOA ${d.soa_no}`}>
      <Page size="A4" style={styles.page}>
        <View style={styles.topRow}>
          <View>
            <Text style={styles.brand}>HHG-SPA</Text>
          ...
          <View>
            ...
            <Text style={[styles.metaLabel, { marginTop: 4 }]}>Issued</Text>
            <Text style={styles.metaVal}>{d.issued_date ?? '—'}</Text>
            <Text style={[styles.metaLabel, { marginTop: 4 }]}>Status</Text>
            <Text style={styles.metaVal}>{d.status.replace('_', ' ').toUpperCase()}</Text>
          </View>
        </View>
        ...
        <Text style={styles.footer}>
          Generated by HHG-SPA POS · {new Intl.DateTimeFormat('en-PH', { timeZone: 'Asia/Manila', dateStyle: 'medium', timeStyle: 'short' }).format(new Date())}
        </Text>
      </Page>
    </Document>
  );
