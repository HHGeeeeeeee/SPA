...
//
// NOTE: tl / fr / de / es / it / ja / ko consent + health wording is a best-effort
// draft — have a native speaker / legal review it before relying on it for liability.

export const KIOSK_LOCALES = ['tl', 'en', 'zh-TW', 'fr', 'es', 'ko', 'ja', 'de', 'it'] as const;
...
export const KIOSK_DICTS: Record<KioskLocale, KioskDict> = {
  tl: {
    nativeName: 'Tagalog',
    title: 'Palatanungan sa Kalusugan at Pahintulot',
    subtitle: 'Pakisagutan ang mga sumusunod bago ang iyong serbisyo',
    name: 'Pangalan',
    email: 'Email',
    phone: 'Telepono',
    age: 'Edad',
    nationality: 'Nasyonalidad',
    hotel: 'Hotel na tinutuluyan',
    gender: 'Kasarian',
    genderMale: 'Lalaki',
    genderFemale: 'Babae',
    genderOther: 'Iba pa',
    genderNa: 'Ayaw sabihin',
    service: 'Mga bahagi ng katawan na gustong pagtuunan',
    servicePlaceholder: 'hal. leeg at balikat, ibabang likod, mga binti',
    pressure: 'Lakas ng masahe',
    pressureSoft: 'Mahina',
    pressureMedium: 'Katamtaman',
    pressureHard: 'Malakas',
    healthTitle: 'Deklarasyon sa kalusugan',
    health: {
      pregnant: 'Buntis o posibleng buntis',
      cardiac: 'Sakit sa puso, mataas na presyon ng dugo, o problema sa sirkulasyon',
      injury: 'Kamakailang operasyon, bali, pilay, o problema sa kasu-kasuan',
      skin: 'Sakit sa balat, sugat, pamamaga, o impeksyon',
      allergy: 'Allergy sa langis, losyon, o partikular na sangkap',
    },
    yes: 'Oo',
    no: 'Hindi',
    healthNote: 'Kung sumagot ka ng "Oo" sa alinman sa itaas, ilarawan ang iyong kondisyon at anumang bahagi na dapat iwasan o ingatan',
    healthNotePlaceholder: 'hal. kamakailang operasyon sa kaliwang tuhod — iwasan ang bahaging iyon',
    consentTitle: 'Pahintulot',
    consentText:
      'Pinatutunayan ko na ang impormasyon sa itaas ay totoo at kumpleto. Nauunawaan ko ang katangian ng serbisyo ng masahe / spa at ang posibleng mga panganib nito, at kusang-loob akong sumasang-ayon na tanggapin ang serbisyo. Tinatanggap ko ang responsibilidad sa anumang kondisyon sa kalusugan na hindi ko ipinahayag.',
    agree: 'Nabasa ko at sumasang-ayon ako sa pahayag sa itaas',
    signatureTitle: 'Lagda',
    signatureHint: 'Pakipirmahan sa ibaba',
    clear: 'Burahin',
    optional: 'opsyonal',
    submit: 'Isumite',
    submitting: 'Isinusumite…',
    errName: 'Pakiusap ilagay ang iyong pangalan',
    errPressure: 'Pakiusap pumili ng lakas ng masahe',
    errSign: 'Pakiusap pumirma',
    errAgree: 'Pakiusap sumang-ayon sa pahayag',
    thankTitle: 'Naisumite na — salamat!',
    thankMsg: 'Pakibalik ang tablet sa front desk.',
    next: 'Susunod na bisita',
  },
  en: {
    nativeName: 'English',
  ...
  fr: {
    nativeName: 'Français',
    title: 'Questionnaire de santé et consentement',
    subtitle: 'Veuillez remplir ce qui suit avant votre soin',
    name: 'Nom',
    email: 'E-mail',
    phone: 'Téléphone',
    age: 'Âge',
    nationality: 'Nationalité',
    hotel: 'Hôtel où vous séjournez',
    gender: 'Genre',
    genderMale: 'Homme',
    genderFemale: 'Femme',
    genderOther: 'Autre',
    genderNa: 'Préfère ne pas dire',
    service: 'Zones sur lesquelles vous aimeriez que nous nous concentrions',
    servicePlaceholder: 'ex. nuque et épaules, bas du dos, jambes',
    pressure: 'Pression du massage',
    pressureSoft: 'Douce',
    pressureMedium: 'Moyenne',
    pressureHard: 'Forte',
    healthTitle: 'Déclaration de santé',
    health: {
      pregnant: 'Enceinte ou possiblement enceinte',
      cardiac: 'Maladie cardiaque, hypertension ou problèmes de circulation',
      injury: 'Chirurgie récente, fracture, entorse ou problèmes articulaires',
      skin: 'Maladie de peau, plaie, inflammation ou infection',
      allergy: 'Allergie aux huiles, lotions ou ingrédients spécifiques',
    },
    yes: 'Oui',
    no: 'Non',
    healthNote: 'Si vous avez répondu « Oui » à l\'une des questions ci-dessus, veuillez décrire votre état et les zones à éviter ou à traiter avec précaution',
    healthNotePlaceholder: 'ex. chirurgie récente du genou gauche — veuillez éviter cette zone',
    consentTitle: 'Consentement',
    consentText:
      'Je déclare que les informations ci-dessus sont véridiques et complètes. Je comprends la nature du service de massage / spa et ses risques possibles, et j\'accepte volontairement de recevoir le service. J\'assume la responsabilité de toute condition de santé que je n\'aurais pas déclarée.',
    agree: 'J\'ai lu et j\'accepte la déclaration ci-dessus',
    signatureTitle: 'Signature',
    signatureHint: 'Veuillez signer ci-dessous',
    clear: 'Effacer',
    optional: 'facultatif',
    submit: 'Soumettre',
    submitting: 'Envoi…',
    errName: 'Veuillez entrer votre nom',
    errPressure: 'Veuillez choisir la pression du massage',
    errSign: 'Veuillez signer',
    errAgree: 'Veuillez accepter la déclaration de consentement',
    thankTitle: 'Soumis — merci !',
    thankMsg: 'Veuillez rendre la tablette à la réception.',
