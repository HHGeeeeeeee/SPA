...
import { ChevronLeft, ChevronRight, Users, BedDouble, CalendarDays, Clock } from 'lucide-react';
...
export function ShiftControls({ branches, branchId, weekStart, day, view, scale }: Props) {
